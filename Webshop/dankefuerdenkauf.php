...
<head>
    ...
    <link rel="stylesheet" href="CSS/dankefuerdenkauf.css">
...
<div id="content">
    <div class='Main'>
        ...
        <?php
            $bID = $_GET['bID'];
        ?>
        <a onclick = 'drucken()'><button>Rechnung downloaden</button></a>
        <br>
        <a href = 'index.php'><button>Zur Startseite</button></a>
    </div>
    <script>
        function drucken(){
            window.open('rechnungdrucken.php?bID=<?=$bID?>', '_blank');
            window.focus();
        }
    </script>
    <footer class="footer">
